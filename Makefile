...
CFLAGS += -Wall -g -DTF_LITE_DISABLE_X86_NEON=1 -Wno-strict-aliasing -lpthread
CFLAGS += -DEIDSP_SIGNAL_C_FN_POINTER=1 -DEI_C_LINKAGE=1 -DEI_CLASSIFIER_SLICES_PER_MODEL_WINDOW=4
CFLAGS += -I.
CFLAGS += -Isource
